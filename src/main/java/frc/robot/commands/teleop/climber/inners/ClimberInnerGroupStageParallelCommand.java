...
public class ClimberInnerGroupStageParallelCommand extends ParallelCommandGroup {
  /** Creates a new ClimberInnerGroupStageParallelCommand. */
  public ClimberInnerGroupStageParallelCommand(PGClimberSubsystem pgClimberSubsystem, InnerClimberSubsystem innerClimberSubsystem) {
