...
public class ClimberInnerJoyCommand extends CommandBase {
  private InnerClimberSubsystem innerClimberSubsystem;
  private Supplier<Double> inners;
  /** Creates a new ClimberInnerJoyCommand. */
  public ClimberInnerJoyCommand(InnerClimberSubsystem innerClimberSubsystem, Supplier<Double> inners) {
